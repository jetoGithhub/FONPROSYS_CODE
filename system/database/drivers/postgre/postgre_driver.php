...
class CI_DB_postgre_driver extends CI_DB {
	...
	function _version()
	{
            // por defecto comentando en fecha 24 de julio por jefferson lara
            
		//return "SELECT version() AS ver";
            
            //fin linea comentada
            
            // nueva linea, agregada para que no traiga inconvenietes el insert_id que se encarga de devolver el id de la tabla donde 
            // se ejectuat el insert
            
                return pg_version($this->db_connect());; 
	}
