	...
	<tbody>
          <?php 
           foreach ($lista_img as $clave => $valor) {
            ...
            if(($separa[1]=='pdf') or ($separa[1]=='docx') or ($separa[1]=='doc') ){$text_ruta='include/imagenes/iconos/ic_pdf.png'; }else{ $text_ruta='archivos/contribuyente/documentos_planilla/miniaturas/'.$valor["ruta_imagen"]; }
            ?>
               <tr>
                        <td><?php print($con); ?></td>
