                                            ...
                                            <tr>
                                                <td valign="top" style="padding-left:10px;">
                                                    <div mc:edit="std_content01">
                                                        ...
                                                        <br/>
                                                            <?php print ($muestra[0]['login']); ?>
                                                        <br/>
                                                        <strong>Nombre</strong>
                                                        <br/>
                                                            <?php print ($muestra[0]['nombre']); ?>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                <td valign="top" style="padding-left:0;">
                                                    <div mc:edit="std_content00">
                                                        <h2 class="h2">CAMBIO DE CONTRASE&Ntilde;A</h2>
                                                        <h3 class="h3">Indicaciones</h3>
                                                        Se ha enviado un token para verificar la validez de la cuenta de correo.<br/>
                                                        Siga el enlace a continuacion para continuar con la recuperacion de su contrase&ntilde;a.<br/>
                                                        
                                                        <a href="<?php print(base_url().'index.php/mod_contribuyente/contribuyente_c/restauraClaveRecibe/'.$token); ?>">Recuperar Contrase&ntilde;a</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
...
Se ha enviado un token para verificar la validez de la cuenta de correo.
        Siga el enlace a continuacion para continuar con la recuperacion de su contraseña.
        <?php print(base_url().'index.php/mod_contribuyente/contribuyente_c/restauraClaveRecibe/'.$token); ?>
