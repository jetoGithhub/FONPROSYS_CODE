...
<page backtop="16mm" backbottom="16mm" backleft="8mm" backright="12mm" style="" >
  <page_header>
    ...
    <page_footer>
     ...
     <br /> 
<p style=" text-align: center; font-weight: bold"><u>PLANILLA DE MULTA EXTEMPORANEA</u></p>
<br /> 
			  ...
			  <td class="cabecera" colspan="3">
					<table border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border-color: black;">
						...
						<tr>
							...
							<td rowspan="2" style="width:100px;"><?php echo 'CNAC/FONPROCINE/<br />GRT/RISE-'.$planilla[0]['nresolucion'] ?></td>
						</tr>
						...
						<tr>
							...
							<td rowspan="2"><?php echo date('d-m-Y',strtotime($planilla[0]['fechanotificacion'])) ?></td>
						</tr>
						...
						<tr>
							...
							<td rowspan="2"><?php echo $this->funciones_complemento->devuelve_cifras_unidades_mil(round($planilla[0]['total_multa'],2)) ?></td>
						</tr>
    ...
    <table class="tabla-cuerpo">
     ...
     <table style="border:1px solid black;" class="tercer_bloque">
		...
		<tr>
			...
			<td>
				<br> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->funciones_complemento->devuelve_cifras_unidades_mil(round($planilla[0]['total_multa'],2)) ?><br> 
			</td>
		</tr>
	 </table>
...
<page backtop="16mm" backbottom="16mm" backleft="8mm" backright="12mm" style="" >
  <page_header>
    ...
    <p style=" text-align: center; font-weight: bold"><u>PLANILLA DE INTERESE POR MULTA EXTEMPORANEA</u></p>
<br /> 
<table class="tabla-cuerpo" border="1" style=" border-collapse: collapse; border-color: black;">
       <tbody align="justify" valign="top"> 
        <tr bgcolor="#AEADAC">
          ...
          <tr>
			  <td class="cabecera" colspan="3">
					<table border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border-color: black;">
						...
						<tr>
							<td class="tercer_bloque">18. FECHA DE NOTIFICACIÓN</td>
							<td><?php echo date('d-m-Y',strtotime($planilla[0]['fechanotificacion'])) ?></td>
							<td rowspan="2" class="tercer_bloque">23. FECHA DE NOTIFICACIÓN</td>
							<td rowspan="2">&nbsp;</td>
						</tr>
						...
						<tr>
							<td class="tercer_bloque">19. INTERESES MORATORIOS</td>
							<td><?php echo $this->funciones_complemento->devuelve_cifras_unidades_mil(round($planilla[0]['total_interes'],2)) ?></td>
						</tr>
    ...
    <table class="tabla-cuerpo">
     ...
     <table style="border:1px solid black;" class="tercer_bloque">
		...
		<tr>
			...
			<td>
				<br> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->funciones_complemento->devuelve_cifras_unidades_mil(round($planilla[0]['total_interes'],2)) ?><br> 
			</td>
		</tr>
	 </table>
</page>
