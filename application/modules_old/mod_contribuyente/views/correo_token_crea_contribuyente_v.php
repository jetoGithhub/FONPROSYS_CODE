                                            ...
                                            <tr>
                                                <td valign="top" style="padding-left:0;">
                                                    <div mc:edit="std_content00">
                                                        <h2 class="h2">Registro de nuevo contribuyente</h2>
                                                        <h3 class="h3">Indicaciones</h3>
                                                        Se ha enviado un token para verificar la validez de la cuenta de correo.<br/>
                                                        Siga el enlace a continuacion para continuar con la creacion de su usuario.<br/>
                                                        
                                                        <a href="<?php print(base_url().'index.php/mod_contribuyente/contribuyente_c/validaToken/'.$token); ?>">Activar Usuario</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
...
Se ha enviado un token para verificar la validez de la cuenta de correo.
        Siga el enlace a continuacion para continuar con la creacion de su usuario.
        <?php print(base_url().'index.php/mod_contribuyente/contribuyente_c/validaToken/'.$token); ?>
