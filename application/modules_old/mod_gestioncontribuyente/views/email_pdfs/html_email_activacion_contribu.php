                                            ...
                                            <tr>
                                                <td valign="top" style="padding-left:10px;">
                                                    <div mc:edit="std_content01">
                                                        <h3 class="h3">NOTIFICACION</h3>
                                                        <strong>Contribuyente</strong>
                                                        <br/>
                                                            <?php print ($contribuyente); ?>
                                                        <br/>
                                            ...
                                            <tr>
                                                <td valign="top" style="padding-left:0;">
                                                    <div mc:edit="std_content00">
                                                        <h2 class="h3">INFORMACION DE REGISTRO FONPROCINE</h2>
                                                       <p style=" text-align: justify">
                                                        por medio de la presente le informamos que
                                                        su registor fue verificado y validado con exito, 
                                                        apartir de este momento puede ingresar al portal con sus datos de usuario 
                                                        y comenzar a relizar sus declaraciones en linea
                                                        <br /><br />
                                                        Muchas gracias por confiar en nosostros.                                                        
                                                       </p>
                                                                                                                
                                                        <!--<a href="<?php // print(base_url().'/contribuyente.php'); ?>">Inicio de sesion</a>-->
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
