 <script>
    $(function() {
        ...
        validador('form_new','<?php echo base_url()."index.php/mod_gestioncontribuyente/envio_correos_c/proc_enviar_correo_contri_inact"; ?>','envio_form');
...
<style>
    ...
    #radio .ui-state-active
    {
       ...
       <form class="form-style focus-estilo" id="form_new">
           ...
           <input name="correo_enviado" type="hidden" id="correo_enviado" value="true" />
           <input name="procesado" type="hidden" id="procesado" value="false" />
            ...
            <div id='espere_enviadoc'> Espere procesando envio...<img  src="<?php print(base_url()); ?>include/imagenes/ajax-loader.gif" /></div>
       </form> 
