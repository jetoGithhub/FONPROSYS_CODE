...
<page backcolor="#AACCFF" backleft="5mm" backright="5mm" backtop="10mm" backbottom="10mm" >
    <table>
        <tr>
            ...
            <td class="div"><div style="rotate: 270;">Hello ! ceci <b>est</b> un test !<br><img src="http://192.168.1.102/fonprosys_code/include/imagenes/cnac.gif" style="width: 80px;" alt="logo"></div></td>
        </tr>
        <tr>
