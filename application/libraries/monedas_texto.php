...
class monedas_texto 
{
    ...
    private function unidad_centimos($numero) {
        switch ($numero) { 
            case 9: { $num_letra = "nueve céntimos"; 
            break; 
...
{ 
    ...
    private function cien_mil() {
     ...
     private function millon() {
         ...
         */
        public function num_to_letras($numero, $moneda = 'BOLIVARES', $subfijo = 'B.s')
        {
            ...
            for ($xz = 0; $xz < 3; $xz++) {
                ...
                if ('' != trim($xaux)) {
                    switch ($xz) {
                        ...
                        case 2:
                            if (1 > $numero) {
                                $xcadena = "CERO {$moneda} CON {$xdecimales} CENTIMOS ( {$numero_min} {$subfijo} )";
                            }
                            if ($numero >= 1 && $numero < 2) {
                                $xcadena = "UN {$moneda} CON {$xdecimales} CENTIMOS ( {$numero_min} {$subfijo} )";
                            }
                            if ($numero >= 2) {
                                $xcadena.= " {$moneda} CON {$xdecimales} CENTIMOS ( {$numero_min} {$subfijo} )"; //
                            }
                            break;
                    } // endswitch ($xz)
                } // ENDIF (trim($xaux) != "")
