...
-- Started on 2013-02-04 09:29:29 VET
...
SELECT pg_catalog.setval('"Usuarios_IDUsuario_seq"', 46, true);
...
SELECT pg_catalog.setval('tbl_permiso_id_permiso_seq', 31, true);
...
SELECT pg_catalog.setval('tbl_rol_usuario_id_rol_usuario_seq', 53, true);
...
-- Completed on 2013-02-04 09:29:30 VET
